...
defineFeature(feature, test => {
  ...
  test('The user is going to play infinite mode', ({given,when,then}) => {
    ...
    when('I fill the data in the form, press submit and press infinite mode button', async () => {
      ...
      await expect(page).toClick('button.infiniteModeButton', { text: '' })

      await expect(page).toClick('button.endGameButton', { text: '' })
    });
